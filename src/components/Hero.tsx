  ...
  return (
    <section id="hero" className="relative pt-24 pb-20 lg:pt-32 lg:pb-24 overflow-hidden min-h-[90vh]">
      ...
      <div className="absolute top-0 left-0 w-full h-full -z-10 opacity-40">
        <div className="absolute top-[-25%] left-[-25%] w-[50%] h-[50%] bg-brand-primary/10 blur-[120px] rounded-full" />
        ...
        <div className="relative w-full h-full flex items-start justify-center lg:justify-end">
          ...
          <div className="hidden lg:block w-full h-full relative">
            <img
              ...
              style={{ 
                maskImage: 'linear-gradient(to left, black 55%, rgba(0,0,0,0.8) 85%, transparent 100%)',
                WebkitMaskImage: 'linear-gradient(to left, black 55%, rgba(0,0,0,0.8) 85%, transparent 100%)',
                filter: 'grayscale(100%) contrast(1.2) brightness(0.75)',
                WebkitFilter: 'grayscale(100%) contrast(1.2) brightness(0.75)'
              }}
              referrerPolicy="no-referrer"
